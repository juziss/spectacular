...
const services = [
  ...
  },
  {
    ...
    description:
      "Tailored cleaning solutions for offices, retail spaces, and commercial properties across London.",
    features: [
      "Office cleaning",
      "Retail spaces",
      "Carpet cleaning",
  ...
  },
  {
    ...
    title: "Deep Cleaning",
    description:
      "Intensive deep cleaning services for properties requiring thorough sanitisation and restoration.",
    features: [
      "Post-construction",
      "Move-in cleaning",
      "Sanitisation",
  ...
  },
  {
    ...
    description:
      "Specialised cleaning services including carpet cleaning, upholstery, and hard floor maintenance.",
    features: [
      "Carpet cleaning",
      "Upholstery care",
      "Floor restoration",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            ...
            of London&apos;s hospitality, property, and business sectors.
          </p>
        </div>
